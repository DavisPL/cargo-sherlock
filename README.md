...
This experiment involves running Cargo-Sherlock on top 100 frequently downloaded crates from crates.io and generating synthetic typosquatted versions of these crates. We provide you a list of top 100 crates from the time of our experiments in the file `top100_crates.csv`. You can run the evaluation script for RQ1 in multiple ways depending on how much time you have:
...
```Bash
python3 eval_rq1.py --use-typo-crates 
```
...
```Bash
python3 eval_rq1.py --use-typo-crates --use-cache
```
